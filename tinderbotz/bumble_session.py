...
class BumbleSession(BaseSession):
    ...
    def superlike(self, randomize_sleep=True):
        superlike_btn = self.browser.find_element(By.XPATH, "//div[@class='encounters-action tooltip-activator encounters-action--superswipe']")
        superlike_btn.click()
        if randomize_sleep:
    ...
    def _parse_prompts(self, story_content: WebElement, geomatch: Geomatch) -> bool:
        ...
        try:
            ...
            story_content.find_element(By.XPATH, ".//section[@class='encounters-story-section encounters-story-section--question']")
            pname: str = story_content.find_element(By.XPATH, q_xpath).find_element(By.TAG_NAME, "h2").get_attribute("innerHTML")
            value: str = story_content.find_element(By.XPATH, a_xpath).find_element(By.TAG_NAME, "p").get_attribute("innerHTML")
    ...
    def _parse_location(self, story_content: WebElement, geomatch: Geomatch) -> bool:
        ...
        try:
            story_content.find_element(By.XPATH, ".//section[@class='encounters-story-section encounters-story-section--location']")
